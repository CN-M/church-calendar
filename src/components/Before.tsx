...
// //  const [gotoBtn, setgotoBtn] = useState('')
//  const [dateInput, setdateInput] = useState('')
//  const [eventDay, seteventDay] = useState('')
//  const [eventDate, seteventDate] = useState('')
//  const [eventsContainer, seteventsContainer] = useState('')
//  const [addEventWrapper, setaddEventWrapper] = useState('')

//  const [eventActive, seteventActive] = useState(false)

// //  const [addEventCloseBtn, setaddEventCloseBtn] = useState('')
...
//  const [addEventSubmit, setaddEventSubmit] = useState('')
...
//     events: [
//       {
//         text: "Event 1 lorem ipsun dolar sit genfa tersd dsad ",
//       },
//       {
//         text: "Event 2",
//       },
...
//   seteventDate(date + " " + months[month] + " " + year)
// }
...
//   seteventsContainer(events)
//   saveEvents();
// }

// const eventWrapper = `${eventActive ? "active" : '' }add-event-wrapper`
...
//     const addEvent = (e: ChangeEvent<HTMLInputElement>) => {
...
//   await api.event.createReminder.useMutation({
//     title: eventTitle,
//     time: timeFrom + " - " + timeTo,
...
//   const events = api.event.getAllReminders.useQuery({})
//   console.log(events)
...
//           <div className="month">
//             <i className="fas fa-angle-left prev" onClick={prev}></i>
//             {/* <div className="date">december 2015</div> */}
//             <div className="date">{date}</div>
//             <i className="fas fa-angle-right next" onClick={next}></i>
//           </div>
...
//             <div>Sat</div>
//           </div>
//           <div className="days" dangerouslySetInnerHTML={daysContainer}></div>
...
//                 onChange={(e: ChangeEvent<HTMLInputElement>) => seteventTimeFrom(e.target.value)}
//               />
//             </div>
//             <div className="add-event-input">
//               <input
...
//                 onChange={(e: ChangeEvent<HTMLInputElement>) => seteventTimeTo(e.target.value)}
//               />
//             </div>
//           </div>
...
//         </div>
//       </div>
//       <button className="add-event" onClick={addEventModal}>
